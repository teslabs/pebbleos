...
#define GAP_LE_AD_FLAGS_TRANSPORT_MASK \
  (GAP_LE_AD_FLAGS_LE_BR_EDR_SIMULT_CONTROLLER_MASK | GAP_LE_AD_FLAGS_LE_BR_EDR_SIMULT_HOST_MASK)
#else
#define GAP_LE_AD_FLAGS_TRANSPORT_MASK GAP_LE_AD_FLAGS_BR_EDR_NOT_SUPPORTED_MASK
#endif
