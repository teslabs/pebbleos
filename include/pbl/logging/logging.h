...
PBL_UNUSED static const uint8_t _pbl_log_module_level;
...
#define PBL_LOG_MODULE_DEFINE(name, level)                                                    \
  PBL_UNUSED static const uint8_t _pbl_log_module_level = (level);                            \
...
#endif
#else
#define PBL_LOG_MODULE_DEFINE(name, level) PBL_UNUSED static const uint8_t _pbl_log_module_level = 0
#endif
