...
#define PBL_BT_AD_FLAGS_TRANSPORT_MASK \
  (PBL_BT_AD_FLAGS_LE_BR_EDR_SIMULT_CONTROLLER_MASK | PBL_BT_AD_FLAGS_LE_BR_EDR_SIMULT_HOST_MASK)
#else
#define PBL_BT_AD_FLAGS_TRANSPORT_MASK PBL_BT_AD_FLAGS_BR_EDR_NOT_SUPPORTED_MASK
#endif
