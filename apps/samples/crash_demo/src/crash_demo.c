...
static void window_load(Window *window) {
  ...
  static const SimpleMenuItem menu_items[] = {
    {.title = "Execute gibberish", .callback = execute_gibberish_menu_cb},
    {.title = "Write to NULL", .callback = write_to_null_menu_cb},
    {.title = "Write to kernel", .callback = write_to_kernel_menu_cb},
    {.title = "Trigger applib assert", .callback = trigger_applib_assert_cb},
    {.title = "Infinite loop", .callback = trigger_infinite_loop},
    {.title = "Loop Log Spam", .callback = trigger_loop_log_spam},
