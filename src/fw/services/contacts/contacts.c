...
static Contact *prv_deserialize_contact(SerializedContact *serialized_contact,
  ...
  bool r = attributes_address_parse_serial_data(
      serialized_contact->num_attributes, serialized_contact->num_addresses,
  ...
  const size_t alloc_size = attributes_address_get_buffer_size(
      serialized_contact->num_attributes, serialized_contact->num_addresses, attributes_per_address,
      string_alloc_size);
  ...
  attributes_address_init(&contact->attr_list, &contact->addr_list, &buffer,
                          serialized_contact->num_attributes, serialized_contact->num_addresses,
                          attributes_per_address);
