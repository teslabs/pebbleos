...
// .major:0x08 .minor:0x01 -- all version fields split up into minor/major; uuid field appended
...
// sdk.major:0x5 .minor:0x0  -- Bump the SDK version for breaking AppMessage changes b/t 2.x alpha
// and beta releases sdk.major:0x5 .minor:0x1  -- Added additional API functions (MenuLayer
// callbacks) sdk.major:0x5 .minor:0x2  -- Changed app heap double free behaviour. sdk.major:0x5
// .minor:0x3  -- Added number_window_get_window (API v2.0 revision 12) sdk.major:0x5 .minor:0x4  --
// Added gbitmap_create_blank (API v2.0 revision 13) and click_recognizer_is_repeating (rev 14)
...
// sdk.major:0x5 .minor:0xf  -- Added clock_is_timezone_set in preparation for timezone support (rev
// 25) sdk.major:0x5 .minor:0x10 -- Added the first i18n API: get_locale (rev 26) sdk.major:0x5
// .minor:0x11 -- Added second i18n API: setlocale (rev 27) sdk.major:0x5 .minor:0x13 -- Export
// mktime (rev 29) sdk.major:0x5 .minor:0x14 -- Rev 30 was a move of several color APIs as to not
// conflict with release 2.9 sdk. Several of these functions were removed after rev 55
// for 3.0-beta10 sdk.major:0x5 .minor:0x15 -- Added timezone APIs (rev 31) sdk.major:0x5
// .minor:0x16 -- Added 3.0 animation API (rev 32) sdk.major:0x5 .minor:0x17 -- Export new gbitmap
// accessors (rev 33) sdk.major:0x5 .minor:0x18 -- Export gbitmap_sequence API (rev 34)
...
// sdk.major:0x5 .minor:0x23 -- Export 3.0 menu_layer_create() and menu_layer_shadow_enable() (rev
// 39) sdk.major:0x5 .minor:0x24 -- Added additional calls to gbitmap_sequence (rev 40)
...
// sdk.major:0x5 .minor:0x28 -- Export menu_layer_cell_is_highlighted() and
// gbitmap_create_palettized_from_1bit() (rev 44) sdk.major:0x5 .minor:0x29 -- Export
// graphics_draw_rotated_bitmap() API (rev 45) sdk.major:0x5 .minor:0x2a -- Added
// action_bar_layer_set_icon_press_animation (rev 46) sdk.major:0x5 .minor:0x2b -- Created
// TextLayerLegacy2 (rev 47) sdk.major:0x5 .minor:0x2c -- Added GDrawCommand (rev 48) sdk.major:0x5
// .minor:0x2d -- Added property_animation_update_uint32 (rev 49) sdk.major:0x5 .minor:0x2e -- Added
// gpath_draw_outline_open (rev 50) sdk.major:0x5 .minor:0x2f -- Fixed legacy time() support (rev
// 51) sdk.major:0x5 .minor:0x30 -- Deprecate inverter layer (rev 52) sdk.major:0x5 .minor:0x31 --
// Added default menu layer colors (rev 53) sdk.major:0x5 .minor:0x32 -- Added
// menu_layer_set_callbacks (rev 54) sdk.major:0x5 .minor:0x33 -- API cleanup, loop_count -->
// play_count (rev 55) sdk.major:0x5 .minor:0x34 -- Added menu_layer_pad_bottom_enable (rev 56)
...
// sdk.major:0x5 .minor:0x48 -- Export menu_layer_is_index_selected and round menu layer cell
// heights (rev 76) sdk.major:0x5 .minor:0x49 -- Added font v3 (no API changes) (rev 76)
...
// sdk.major:0x5 .minor:0x50 -- 4.0: Add health service expansion, UnobstructedArea, AppGlance,
// AppExitReason, result duration (rev 83) sdk.major:0x5 .minor:0x51 -- Add memory_cache_flush()
// (rev 84) sdk.major:0x5 .minor:0x52 -- rocky_event_loop_with_resource (rev. 85) sdk.major:0x5
// .minor:0x53 -- Add health_service heart rate sampling period support (rev 86) sdk.major:0x5
// .minor:0x54 -- Add PlatformType enum and defines (rev 87) sdk.major:0x5 .minor:0x55 -- Preferred
// Content Size (rev 88) sdk.major:0x5 .minor:0x56 -- Add PlatformType enum and defines (rev 89)
...
// sdk.major:0x5 .minor:0x5c -- Add light_is_on() and expose touch_service_subscribe/unsubscribe to
// apps (rev 95) sdk.major:0x5 .minor:0x5d -- Add app_light_set_color_rgb888() for 8-bit-per-channel
// backlight tint (rev 96) sdk.major:0x5 .minor:0x5e -- Add Speaker API (rev 97) sdk.major:0x5
...
//! @internal
//! Version data structure with minor & major versions: When making non-backwards-compatible
...
typedef struct PBL_PACKED {
  ...
  uint32_t sym_table_addr; //!< The system will poke the sdk's symbol table address into this field
                           //!< on load
