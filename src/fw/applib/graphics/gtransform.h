...
#define GTransformFromNumbers(a, b, c, d, tx, ty)                          \
  GTransform(GTransformNumberFromNumber(a), GTransformNumberFromNumber(b), \
             GTransformNumberFromNumber(c), GTransformNumberFromNumber(d), \
...
#define GTransformIdentity()                                                         \
  (GTransform) {                                                                     \
    .a = GTransformNumberOne, .b = GTransformNumberZero, .c = GTransformNumberZero,  \
    .d = GTransformNumberOne, .tx = GTransformNumberZero, .ty = GTransformNumberZero \
  }
...
#define GTransformScale(sx, sy)                                             \
  (GTransform) {                                                            \
    .a = sx, .b = GTransformNumberZero, .c = GTransformNumberZero, .d = sy, \
    .tx = GTransformNumberZero, .ty = GTransformNumberZero                  \
  }
...
#define GTransformTranslation(tx_v, ty_v)                                           \
  (GTransform) {                                                                    \
    .a = GTransformNumberOne, .b = GTransformNumberZero, .c = GTransformNumberZero, \
    .d = GTransformNumberOne, .tx = tx_v, .ty = ty_v                                \
  }
...
#define gtransform_scale_number(t_new, t, sx, sy) \
  gtransform_scale(t_new, t, GTransformNumberFromNumber(sx), GTransformNumberFromNumber(sy))
...
#define gtransform_translate_number(t_new, t, tx, ty) \
  gtransform_translate(t_new, t, GTransformNumberFromNumber(tx), GTransformNumberFromNumber(ty))
