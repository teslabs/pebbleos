...
bool recursive_bezier_fixed(GPathBuilder *builder, int32_t x1, int32_t y1, int32_t x2, int32_t y2,
  ...
  // Angle Condition
  int32_t a23 =
      atan2_lookup((int16_t)((y3 - y2) / fixedpoint_base), (int16_t)((x3 - x2) / fixedpoint_base));
  int32_t da1 = abs(a23 - atan2_lookup((int16_t)((y2 - y1) / fixedpoint_base),
                                       (int16_t)((x2 - x1) / fixedpoint_base)));
  int32_t da2 = abs(
      atan2_lookup((int16_t)((y4 - y3) / fixedpoint_base), (int16_t)((x4 - x3) / fixedpoint_base)) -
      a23);
  ...
  if (da1 + da2 < max_angle_tolerance) {
    ...
    return gpath_builder_line_to_point(builder,
                                       GPoint(x1234 / fixedpoint_base, y1234 / fixedpoint_base));
  }
