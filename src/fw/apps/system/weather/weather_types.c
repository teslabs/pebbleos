...
uint32_t weather_type_icon_tiny_resource(WeatherType weather_type) {
  static const uint16_t s_resources[] = {
    RESOURCE_ID_IMAGE_PARTLY_CLOUDY_TINY,   RESOURCE_ID_IMAGE_CLOUDY_DAY_TINY,
    RESOURCE_ID_IMAGE_LIGHT_SNOW_TINY,      RESOURCE_ID_IMAGE_LIGHT_RAIN_TINY,
    RESOURCE_ID_IMAGE_HEAVY_RAIN_TINY,      RESOURCE_ID_IMAGE_HEAVY_SNOW_TINY,
    RESOURCE_ID_IMAGE_GENERIC_WEATHER_TINY, RESOURCE_ID_IMAGE_SUNNY_DAY_TINY,
    RESOURCE_ID_IMAGE_RAIN_AND_SNOW_TINY,   RESOURCE_ID_IMAGE_GENERIC_WEATHER_TINY,
  };
