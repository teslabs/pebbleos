...
#endif
      data->mac_buffer, strlen(data->mac_buffer), QRCodeECCMedium, GColorBlack, GColorWhite);
...
const PebbleProcessMd *mfg_adv_app_get_info(void) {
  static const PebbleProcessMdSystem s_app_info = {
    ...
    .common.uuid =
        {0x4c, 0x8e, 0x2a, 0x1f, 0x7d, 0x3b, 0x4f, 0x9e, 0xb5, 0xa2, 0x6e, 0x1c, 0x8d, 0x3f, 0x7a,
         0x9b},
    .name = "MfgAdv",
  };
