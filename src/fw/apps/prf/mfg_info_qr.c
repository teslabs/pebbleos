...
static const char *prv_get_color_short_name(WatchInfoColor color) {
  ...
  for (const ColorTable *entry = s_color_table; entry < s_color_table + ARRAY_LENGTH(s_color_table);
       entry++) {
...
const PebbleProcessMd *mfg_info_qr_app_get_info(void) {
  static const PebbleProcessMdSystem s_app_info = {
    ...
    .common.uuid =
        {0x4f, 0x8a, 0x2d, 0x3e, 0x1c, 0x5b, 0x4a, 0x9f, 0x8e, 0x7d, 0x6c, 0x3b, 0x2a, 0x1f, 0x0e,
         0x9d},
    .name = "MfgInfoQR",
  };
