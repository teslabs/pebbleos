...
static AccelRawData s_walk_30_steps[] = {
  {-42, -52, -1027},  {-43, -29, -1054},   {-76, 12, -975},    {-72, -17, -906},
  {-64, -40, -892},   {-81, -37, -933},    {-77, -15, -1008},  {-83, 0, -1041},
  {-81, -27, -1029},  {-80, -57, -993},    {-97, -27, -973},   {-119, -21, -991},
  {-120, -19, -1011}, {-115, -27, -978},   {-106, -44, -953},  {-104, -62, -946},
  {-150, -90, -962},  {-148, -66, -991},   {-164, -101, -980}, {-162, -102, -975},
  {-223, -67, -966},  {-251, -84, -971},   {-118, -134, -968}, {-159, -54, -956},
  {-160, -125, -958}, {-102, -152, -963},  {-39, -154, -974},  {63, -317, -986},
  {-61, -190, -1000}, {-131, -306, -1022}, {-189, -295, -844}, {-224, -317, -694},
  {-243, -177, -563}, {-420, 58, -499},    {-677, 416, -469},  {-796, 908, -426},
  {-844, 1100, -288}, {-762, 824, -233},   {-813, 1019, -270}, {-816, 1041, -119},
  {-865, 914, -6},    {-848, 872, 24},     {-817, 776, 42},    {-765, 655, 14},
  {-804, 635, -20},   {-839, 657, 13},     {-874, 659, -1},    {-926, 587, -19},
  {-976, 510, -31},   {-937, 466, -78},    {-1187, 483, 24},   {-1046, 482, -87},
  {-1071, 566, -238}, {-884, 460, -301},   {-844, 144, -211},  {-880, 213, -78},
  {-972, -2, 38},     {-786, 53, 32},      {-739, 232, -12},   {-695, 344, -61},
  {-706, 394, -72},   {-743, 351, -67},    {-775, 334, -58},   {-819, 333, -45},
  {-869, 365, -70},   {-833, 405, -36},    {-1466, 634, 18},   {-1132, 698, -39},
  {-849, 548, -59},   {-1073, 483, -47},   {-970, 540, -84},   {-883, 458, -35},
  {-781, 364, -41},   {-732, 345, -40},    {-751, 324, 2},     {-752, 287, 42},
  {-727, 285, 29},    {-718, 304, 44},     {-813, 325, 79},    {-903, 335, 75},
  {-880, 323, 4},     {-1093, 404, 57},    {-1177, 388, 76},   {-1098, 513, -82},
  {-892, 549, -256},  {-739, 484, -199},   {-695, 337, -82},   {-846, 302, 0},
  {-787, 298, 24},    {-712, 392, 29},     {-733, 439, -20},   {-740, 464, -49},
  {-739, 450, -50},   {-752, 411, -87},    {-837, 438, -93},   {-961, 453, -73},
  {-994, 442, -23},   {-1059, 466, 2},     {-1222, 594, 33},   {-997, 552, 30},
  {-873, 477, -30},   {-850, 443, 32},     {-894, 421, 62},    {-891, 367, 102},
  {-873, 322, 164},   {-865, 316, 181},    {-804, 364, 150},   {-757, 337, 158},
  {-714, 338, 110},   {-721, 405, 71},     {-721, 419, 53},    {-725, 400, 35},
  {-737, 373, 55},    {-752, 386, 57},     {-865, 451, 64},    {-928, 486, 99},
  {-1113, 519, 257},  {-1147, 531, 305},   {-1069, 693, 49},   {-815, 808, -126},
  {-679, 568, -43},   {-748, 421, 29},     {-886, 316, 59},    {-906, 306, 26},
  {-846, 369, 0},     {-843, 404, -15},    {-828, 396, -2},    {-826, 358, 23},
  {-755, 300, 41},    {-700, 305, 46},     {-747, 377, 28},    {-794, 416, 47},
  {-1102, 470, 161},  {-1303, 549, 281},   {-1194, 656, 238},  {-709, 508, 77},
  {-734, 453, 115},   {-739, 456, 199},    {-781, 422, 258},   {-758, 330, 258},
  {-708, 344, 240},   {-780, 317, 285},    {-817, 324, 263},   {-829, 355, 210},
  {-858, 364, 164},   {-906, 377, 157},    {-923, 359, 98},    {-887, 352, 9},
  {-1061, 369, 100},  {-1180, 384, 148},   {-922, 410, 5},     {-778, 464, -90},
  {-770, 444, -26},   {-841, 375, 6},      {-837, 321, 52},    {-757, 354, 58},
  {-745, 372, 36},    {-737, 432, -16},    {-759, 420, -26},   {-783, 429, -53},
  {-824, 437, -80},   {-883, 473, -85},    {-907, 472, -54},   {-856, 403, 17},
  {-1254, 537, 65},   {-1046, 516, 93},    {-1008, 479, 88},   {-771, 420, 33},
  {-884, 437, 88},    {-907, 417, 109},    {-837, 382, 101},   {-802, 361, 88},
  {-789, 363, 102},   {-788, 318, 123},    {-761, 264, 123},   {-762, 273, 114},
  {-790, 335, 109},   {-870, 325, 138},    {-913, 337, 109},   {-871, 357, 18},
  {-1159, 395, 84},   {-1036, 382, 52},    {-907, 491, -125},  {-798, 533, -195},
  {-784, 460, -111},  {-835, 375, -31},    {-840, 327, -9},    {-773, 403, -1},
  {-739, 434, -30},   {-773, 450, -57},    {-786, 449, -64},   {-862, 447, -89},
  {-934, 463, -112},  {-975, 473, -92},    {-897, 430, -62},   {-851, 399, -43},
  {-1183, 530, 30},   {-984, 538, 30},     {-940, 525, 39},    {-779, 470, 31},
  {-915, 462, 97},    {-916, 397, 174},    {-881, 386, 167},   {-840, 391, 157},
  {-766, 343, 177},   {-755, 324, 191},    {-769, 317, 192},   {-807, 352, 193},
  {-821, 380, 179},   {-916, 396, 179},    {-928, 360, 144},   {-871, 359, 34},
  {-1104, 362, 83},   {-1048, 368, -61},   {-819, 467, -296},  {-747, 536, -384},
  {-840, 488, -258},  {-858, 404, -178},   {-831, 316, -141},  {-734, 466, -161},
  {-715, 431, -110},  {-760, 436, -88},    {-762, 422, -44},   {-726, 430, -46},
  {-778, 447, -31},   {-872, 477, -16},    {-987, 484, 33},    {-962, 420, 126},
  {-1254, 472, 174},  {-1012, 451, 128},   {-1023, 473, 152},  {-863, 461, 115},
  {-836, 440, 169},   {-887, 418, 182},    {-946, 397, 235},   {-878, 358, 206},
  {-779, 327, 142},   {-748, 269, 156},    {-745, 232, 145},   {-737, 260, 111},
  {-772, 324, 96},    {-874, 366, 115},    {-954, 347, 148},   {-919, 360, 83},
  {-994, 403, 83},    {-1132, 383, 116},   {-907, 417, -30},   {-861, 496, -124},
  {-853, 482, -98},   {-822, 430, -71},    {-876, 385, -36},   {-836, 391, -41},
  {-742, 396, -49},   {-721, 389, -60},    {-735, 392, -67},   {-753, 370, -68},
  {-803, 402, -92},   {-871, 446, -113},   {-954, 472, -109},  {-941, 440, -62},
  {-1021, 428, -15},  {-1181, 546, -10},   {-979, 498, 48},    {-970, 454, 18},
  {-808, 412, 6},     {-925, 465, -8},     {-942, 404, 39},    {-851, 352, 49},
  {-788, 336, 43},    {-760, 304, 71},     {-755, 270, 106},   {-744, 257, 119},
  {-724, 280, 111},   {-745, 307, 103},    {-874, 345, 116},   {-948, 331, 95},
  {-958, 361, 58},    {-1237, 397, 140},   {-1129, 438, 48},   {-948, 546, -138},
  {-796, 531, -202},  {-748, 418, -147},   {-886, 384, -85},   {-855, 300, -62},
  {-760, 381, -50},   {-739, 410, -87},    {-748, 417, -89},   {-741, 405, -79},
  {-772, 384, -87},   {-857, 422, -101},   {-937, 444, -100},  {-926, 409, -69},
  {-1087, 440, -28},  {-1202, 533, -44},   {-928, 472, -23},   {-904, 425, -81},
  {-781, 414, -98},   {-934, 455, -72},    {-974, 342, -20},   {-927, 341, 31},
  {-833, 357, 6},     {-759, 306, 20},     {-772, 292, 64},    {-784, 281, 90},
  {-770, 289, 75},    {-769, 301, 64},     {-791, 281, 84},    {-865, 311, 77},
  {-905, 356, 34},    {-928, 376, 34},     {-1242, 424, 119},  {-1062, 453, 58},
  {-963, 584, -126},  {-810, 527, -67},    {-812, 403, -9},    {-880, 330, 21},
  {-792, 329, 40},    {-692, 363, 0},      {-689, 397, -46},   {-698, 405, -71},
  {-710, 379, -79},   {-795, 419, -102},   {-892, 468, -119},  {-1012, 491, -96},
  {-1024, 453, -41},  {-1262, 560, -19},   {-1120, 525, 57},   {-1004, 434, 31},
  {-819, 398, 63},    {-761, 405, 134},    {-779, 464, 82},    {-827, 455, 99},
  {-837, 389, 148},   {-752, 410, 137},    {-744, 386, 145},   {-753, 364, 124},
  {-760, 335, 143},   {-818, 328, 129},    {-916, 308, 157},   {-985, 295, 165},
  {-905, 312, 83},    {-1069, 368, 131},   {-1014, 358, 120},  {-917, 443, -7},
  {-762, 490, -147},  {-820, 544, -160},   {-753, 418, -100},  {-873, 373, -25},
  {-828, 364, -24},   {-806, 406, -60},    {-757, 431, -105},  {-779, 418, -84},
  {-790, 383, -105},  {-818, 393, -119},   {-869, 437, -133},  {-958, 461, -104},
  {-874, 410, -26},   {-1208, 503, 46},    {-1075, 527, 44},   {-1014, 502, 99},
  {-824, 458, 24},    {-782, 446, 43},     {-865, 422, 82},    {-919, 364, 130},
  {-861, 358, 110},   {-805, 357, 114},    {-762, 325, 130},   {-742, 301, 138},
  {-749, 298, 147},   {-748, 305, 139},    {-820, 341, 119},   {-918, 331, 138},
  {-959, 353, 88},    {-1027, 388, 79},    {-1112, 380, 70},   {-941, 440, -98},
  {-921, 522, -223},  {-848, 539, -239},   {-787, 394, -149},  {-890, 329, -70},
  {-888, 341, -52},   {-802, 381, -61},    {-742, 399, -88},   {-739, 403, -76},
  {-741, 364, -54},   {-778, 357, -64},    {-824, 402, -103},  {-912, 451, -105},
  {-893, 426, -70},   {-854, 394, -25},    {-1267, 545, 34},   {-982, 546, 27},
  {-927, 455, 9},     {-748, 444, -42},    {-903, 476, 7},     {-953, 465, 38},
  {-921, 406, 49},    {-860, 382, 61},     {-795, 328, 60},    {-754, 280, 78},
  {-753, 287, 83},    {-765, 291, 78},     {-797, 304, 77},    {-847, 303, 95},
  {-918, 302, 89},    {-887, 346, 49},     {-1206, 375, 146},  {-995, 384, 52},
  {-932, 490, -80},   {-823, 524, -140},   {-810, 473, -113},  {-851, 386, -78},
  {-886, 362, -59},   {-796, 392, -45},    {-744, 396, -58},   {-750, 414, -62},
  {-779, 421, -56},   {-811, 410, -65},    {-856, 427, -90},   {-905, 457, -110},
  {-955, 463, -115},  {-914, 431, -86},    {-1064, 447, -36},  {-1068, 509, -51},
  {-999, 499, 27},    {-961, 451, 18},     {-752, 419, -8},    {-857, 444, 25},
  {-909, 409, 75},    {-885, 376, 99},     {-835, 344, 123},   {-760, 307, 120},
  {-767, 296, 143},   {-763, 289, 170},    {-773, 310, 156},   {-796, 343, 134},
  {-853, 329, 167},   {-913, 337, 137},    {-966, 368, 124},   {-1257, 386, 184},
  {-891, 391, -52},   {-823, 535, -266},   {-770, 518, -245},  {-864, 431, -138},
  {-955, 288, -95},   {-936, 358, -128},   {-833, 497, -102},  {-782, 576, -113},
  {-774, 534, -104},  {-798, 395, -78},    {-801, 330, -25},   {-849, 397, -49},
  {-879, 440, -35},   {-875, 421, 0},      {-841, 395, 46},    {-983, 424, 95},
  {-1097, 478, 126},  {-983, 499, 146},    {-854, 450, 37},    {-674, 450, 43},
  {-906, 448, 80},    {-965, 379, 158},    {-882, 328, 162},   {-835, 354, 136},
  {-857, 347, 171},   {-828, 307, 190},    {-841, 307, 192},   {-855, 339, 173},
  {-863, 323, 195},   {-876, 319, 192},    {-888, 320, 150},   {-841, 343, 63},
  {-918, 377, 11},    {-1145, 392, 66},    {-866, 384, -129},  {-768, 485, -290},
  {-796, 530, -255},  {-900, 510, -141},   {-970, 376, -113},  {-891, 346, -100},
  {-797, 395, -38},   {-774, 526, -58},    {-837, 453, -35},   {-840, 405, 9},
  {-844, 380, 31},    {-854, 443, 22},     {-892, 420, 43},    {-889, 378, 65},
  {-872, 362, 99},    {-841, 375, 101},    {-1106, 546, 141},  {-936, 614, 132},
  {-945, 643, 140},   {-825, 713, 168},    {-854, 725, 255},   {-891, 784, 293},
  {-835, 912, 310},   {-788, 924, 269},    {-691, 953, 207},   {-603, 999, 171},
};
...
static void prv_test_nap(void *context) {
  ...
  if (nap_count > 0 || sleep_count == 0) {
    PBL_LOG_ERR("FAILED: expected only sleep but got %d naps and %d sleep", nap_count, sleep_count);
  ...
  PBL_LOG_DBG("Found %d sleep sessions and %d nap sessions", sleep_count, nap_count);
  if (nap_count == 0 || sleep_count > 0) {
    PBL_LOG_ERR("FAILED: expected only naps but got %d nap and %d sleep", nap_count, sleep_count);
    prv_test_end(context, false);
    return;
  }
...
static void prv_health_event_handler(HealthEventType event, void *context) {
  ...
  if (event == HealthEventMovementUpdate) {
    ...
    APP_LOG(APP_LOG_LEVEL_DEBUG, "Got steps update event.(today value: %d)", (int)steps_today);
...
static TestEntry s_test_entries[] = {
  ...
  {.title = "fill sleep", .callback = prv_test_fill_sleep},
  {.title = "sleep reward", .callback = prv_test_sleep_reward},
...
static void prv_window_load(Window *window) {
  ...
  for (uint32_t i = 0; i < num_tests; i++) {
    menu_items[i] = (SimpleMenuItem){.title = s_test_entries[i].title, .callback = prv_test_begin};
  }
