...
static const struct pbl_i2c_dev s_i2c_aw2016 = PBL_I2C_DEV(&s_i2c_bus_1.bus, 0x64);

const struct pbl_i2c_dev *const I2C_AW2016 = &s_i2c_aw2016;

PBL_I2C_SF32LB_DEFINE(s_i2c_bus_2, "i2c2", I2C2, 5, 400000,
                      PBL_PINMUX(PAD_PA32, I2C2_SCL, PIN_NOPULL),
                      PBL_PINMUX(PAD_PA33, I2C2_SDA, PIN_NOPULL), NULL);
...
static const struct pbl_i2c_dev s_i2c_lis2dw12 = PBL_I2C_DEV(&s_i2c_bus_2.bus, 0x18);
#else
...
PBL_I2C_SF32LB_DEFINE(s_i2c_bus_3, "i2c3", I2C3, 5, 400000,
                      ...
                      PBL_PINMUX(PAD_PA10, I2C3_SDA, PIN_NOPULL), NULL);

static const struct pbl_i2c_dev s_i2c_cst816 = PBL_I2C_DEV(&s_i2c_bus_3.bus, 0x15);
...
PBL_I2C_SF32LB_DEFINE(s_i2c_bus_4, "i2c4", I2C4, 5, 400000,
                      PBL_PINMUX(PAD_PA09, I2C4_SCL, PIN_NOPULL),
                      PBL_PINMUX(PAD_PA20, I2C4_SDA, PIN_NOPULL), NULL);

static const struct pbl_i2c_dev s_i2c_gh3x2x = PBL_I2C_DEV(&s_i2c_bus_4.bus, 0x14);
...
void board_init(void) {
  ...
  pbl_i2c_use(&s_i2c_lis2dw12);
  pbl_i2c_write_register(&s_i2c_lis2dw12, 0x21, (1U << 6U));
#if defined(CONFIG_BOARD_OBELIX_DVT) || defined(CONFIG_BOARD_OBELIX_BB2)
  ...
  uint8_t undoc;
  if (pbl_i2c_read_register(&s_i2c_lis2dw12, 0x17, &undoc)) {
    pbl_i2c_write_register(&s_i2c_lis2dw12, 0x17, undoc | (1U << 6U));
  }
#endif
  pbl_i2c_release(&s_i2c_lis2dw12);
