...
void flash_erase_sector_blocking(uint32_t sector_addr) {
  s_command_list[s_command_list_index++] =
      (EraseCommand){.addr = sector_addr, .type = SectorEraseCommand};
}

void flash_erase_subsector(uint32_t subsector_addr, FlashOperationCompleteCb cb, void *context) {
  s_command_list[s_command_list_index++] =
      (EraseCommand){.addr = subsector_addr, .type = SubsectorEraseCommand};
...
void flash_erase_sector(uint32_t sector_addr, FlashOperationCompleteCb cb, void *context) {
  s_command_list[s_command_list_index++] =
      (EraseCommand){.addr = sector_addr, .type = SectorEraseCommand};
  cl_assert_equal_i(s_erase_mutex_locked, true);
  cb(context, (--s_simulate_flash_driver_error_countdown ? S_SUCCESS : E_BUSY));
...
static void prv_test_erase_optimal_range(uint32_t min_start, uint32_t max_start, uint32_t min_end,
                                         uint32_t max_end, EraseCommand *expected_commands) {
  flash_erase_optimal_range(min_start, max_start, min_end, max_end, prv_callback, s_callback_ctx);
  prv_assert_erase_commands(expected_commands);
  prv_assert_callback_called(s_command_list_index ? S_SUCCESS : S_NO_ACTION_REQUIRED);
}
...
void test_flash_erase__sectors_simple_1(void) {
  ...
  prv_test_erase_optimal_range(64 * 1024, 64 * 1024, 2 * 64 * 1024, 2 * 64 * 1024,
                               (EraseCommand[]){
...
void test_flash_erase__sectors_simple_2(void) {
  ...
  prv_test_erase_optimal_range(0, 64 * 1024, 2 * 64 * 1024, 3 * 64 * 1024,
                               (EraseCommand[]){
                                 {64 * 1024, SectorEraseCommand},
                                 {},
                               });
...
void test_flash_erase__two_sectors(void) {
  ...
  prv_test_erase_optimal_range(0, 64 * 1024, 3 * 64 * 1024, 4 * 64 * 1024,
                               (EraseCommand[]){
                                 {64 * 1024, SectorEraseCommand},
...
void test_flash_erase__subsectors_1(void) {
  ...
  prv_test_erase_optimal_range(0, 4 * 1024, 64 * 1024, 64 * 1024,
                               (EraseCommand[]){
...
void test_flash_erase__sector_and_subsector(void) {
  ...
  prv_test_erase_optimal_range(60 * 1024, 60 * 1024, 2 * 64 * 1024, 2 * 64 * 1024,
                               (EraseCommand[]){
...
void test_flash_erase__subsectors_on_both_sides(void) {
  ...
  prv_test_erase_optimal_range(60 * 1024, 60 * 1024, ((2 * 64) + 4) * 1024, ((2 * 64) + 8) * 1024,
                               (EraseCommand[]){
                                 {60 * 1024, SubsectorEraseCommand},
                                 {64 * 1024, SectorEraseCommand},
...
void test_flash_erase__96k_app_banks_1(void) {
  ...
  prv_test_erase_optimal_range(0, 0, 32 * 1024, 96 * 1024,
                               (EraseCommand[]){
                                 {0, SectorEraseCommand},
                                 {},
                               });
...
void test_flash_erase__96k_app_banks_2(void) {
  ...
  prv_test_erase_optimal_range(0, 0, 69 * 1024, 96 * 1024,
                               (EraseCommand[]){
                                 {0, SectorEraseCommand},
...
void test_flash_erase__96k_app_banks_3(void) {
  ...
  prv_test_erase_optimal_range(32 * 1024, 32 * 1024, (32 + 18) * 1024, (32 + 96) * 1024,
                               (EraseCommand[]){
...
void test_flash_erase__96k_app_banks_4(void) {
  ...
  prv_test_erase_optimal_range(32 * 1024, 32 * 1024, (32 + 71) * 1024, (32 + 96) * 1024,
                               (EraseCommand[]){
                                 {32 * 1024, SubsectorEraseCommand},
                                 {36 * 1024, SubsectorEraseCommand},
                                 {40 * 1024, SubsectorEraseCommand},
...
void test_flash_erase__watch_and_learn(void) {
  ...
  prv_test_erase_optimal_range(0x320000, 0x320000, 0x33177c, 0x338000,
                               (EraseCommand[]){
...
void test_flash_erase__handle_work_queue_full(void) {
  ...
  flash_erase_optimal_range(32 * 1024, 32 * 1024, (32 + 71) * 1024, (32 + 96) * 1024, prv_callback,
                            s_callback_ctx);
