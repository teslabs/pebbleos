...
static GDrawCommandList *prv_create_command_list_3(void) {
  GDrawCommandList *command_list =
      malloc(sizeof(GDrawCommandList) + (3 * sizeof(GDrawCommand)) + (sizeof(GPoint) * 6));
  *command_list = (GDrawCommandList){.num_commands = 3};
...
void test_gdraw_command__draw_command_list(void) {
  GDrawCommandList *command_list =
      malloc(sizeof(GDrawCommandList) + sizeof(GDrawCommand) + (sizeof(GPoint) * 2));
  *command_list = (GDrawCommandList){.num_commands = 1};
...
void test_gdraw_command__validate_list(void) {
  ...
  size_t size = sizeof(GDrawCommandList) + (3 * sizeof(GDrawCommand)) + (sizeof(GPoint) * 6);
...
void test_gdraw_command__validate_image(void) {
  ...
  GDrawCommandList *command_list = prv_create_command_list_3();
  memcpy(&image->command_list, command_list,
         sizeof(GDrawCommandList) + (3 * sizeof(GDrawCommand)) + (sizeof(GPoint) * 6));
  free(command_list);
...
void test_gdraw_command__draw_image(void) {
  GDrawCommandImage *image =
      malloc(sizeof(GDrawCommandImage) + sizeof(GDrawCommand) + (sizeof(GPoint) * 2));
...
void test_gdraw_command__draw_frame(void) {
  GDrawCommandFrame *frame =
      malloc(sizeof(GDrawCommandFrame) + sizeof(GDrawCommand) + (sizeof(GPoint) * 2));
...
static void prv_set_stroke_color(GDrawCommandProcessor *processor, GDrawCommand *processed_command,
