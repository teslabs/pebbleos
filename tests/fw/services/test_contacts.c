...
#define ADDRESS_1_UUID \
  0xc2, 0x77, 0x31, 0x10, 0xcc, 0x01, 0x44, 0x4b, 0xaa, 0x46, 0xe0, 0xa8, 0xbe, 0xd6, 0x6e, 0x43
...
void test_contacts__get_contact_by_uuid(void) {
  ...
  cl_assert_equal_i(contacts_db_insert((uint8_t *)&uuid, UUID_SIZE, (uint8_t *)&serialized_contact,
                                       sizeof(serialized_contact)),
                    0);
