...
static void prv_assert_last_event(PhoneEventType subtype, bool check_cookie, bool check_name_number,
...
void test_phone_pp__incoming_no_name(void) {
  uint8_t pp_msg[] = {0x04, 0x1a, 0xd4, 0x77, 0x08, 0x0d, 0x35, 0x35, 0x35, 0x2D,
                      0x35, 0x35, 0x35, 0x2D, 0x35, 0x35, 0x35, 0x35, 0x00, // "555-555-5555"
                      0x00};
  phone_protocol_msg_callback(s_session, pp_msg, sizeof(pp_msg));
  fake_system_task_callbacks_invoke_pending();
  prv_assert_last_event(PhoneEventType_Incoming, true /* check_cookie */,
                        true /* check_name_number */, "", "555-555-5555");
}

void test_phone_pp__incoming_no_number(void) {
  uint8_t pp_msg[] = {0x04, 0x1a, 0xd4, 0x77, 0x08, 0x00, 0x06,
                      0x42, 0x6F, 0x62, 0x62, 0x79, 0x00}; // "Bobby"
  phone_protocol_msg_callback(s_session, pp_msg, sizeof(pp_msg));
  fake_system_task_callbacks_invoke_pending();
  prv_assert_last_event(PhoneEventType_Incoming, true /* check_cookie */,
                        true /* check_name_number */, "Bobby", "");
}
...
void test_phone_pp__incoming(void) {
  ...
  fake_system_task_callbacks_invoke_pending();
  prv_assert_last_event(PhoneEventType_Incoming, true /* check_cookie */,
                        true /* check_name_number */, "Bobby", "555-555-5555");
}
...
static void prv_assert_decline_call_sent_cb(uint16_t endpoint_id, const uint8_t *data,
                                            unsigned int data_length) {
...
static void prv_assert_get_phone_call_state_sent_cb(uint16_t endpoint_id, const uint8_t *data,
                                                    unsigned int data_length) {
...
void test_phone_pp__get_phone_call_state_response_two_started_calls(void) {
  pp_get_phone_state_set_enabled(true);
  uint8_t pp_msg[] = {0x83, 0x05, 0x12, 0x34, 0x45, 0x67, 0x89, 0x05, 0x08, 0x1a, 0xd4, 0x77, 0x08};
  phone_protocol_msg_callback(s_session, pp_msg, sizeof(pp_msg));
  fake_system_task_callbacks_invoke_pending();
...
void test_phone_pp__get_phone_call_state_response_incoming(void) {
  pp_get_phone_state_set_enabled(true);
  uint8_t pp_msg[] = {0x83, 0x07, 0x04, 0x1a, 0xd4, 0x77, 0x08, 0x00, 0x00};
  phone_protocol_msg_callback(s_session, pp_msg, sizeof(pp_msg));
  fake_system_task_callbacks_invoke_pending();
