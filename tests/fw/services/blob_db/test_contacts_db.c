...
#define ADDRESS_1_UUID \
  0xd3, 0x72, 0x2d, 0x75, 0x6b, 0x21, 0x49, 0x2a, 0x9c, 0xc7, 0x5f, 0xf8, 0x4d, 0xd2, 0x5a, 0x9c
#define ADDRESS_2_UUID \
  0x43, 0x03, 0x91, 0x06, 0x80, 0x39, 0x48, 0xea, 0x92, 0x72, 0xf3, 0x4c, 0xd5, 0x35, 0x9c, 0xcf
...
void test_contacts_db__insert(void) {
  ...
  cl_assert_equal_i(
      contacts_db_insert((uint8_t *)&contact, UUID_SIZE, (uint8_t *)&contact, sizeof(contact)), 0);
  ...
  cl_assert_equal_i(contacts_db_read((uint8_t *)&contact, UUID_SIZE, contact_out, sizeof(contact)),
                    0);
