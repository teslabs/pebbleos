...
static void prv_sent_data_cb(uint16_t endpoint_id, const uint8_t *data, unsigned int data_length) {
...
void test_blob_db_endpoint__handle_insert_command_zero_key_size(void) {
  ...
  // Process Command
  uint8_t *resp_ptr =
      process_blob_db_command(s_insert_cmd_zero_key_size, sizeof(s_insert_cmd_zero_key_size));
...
void test_blob_db_endpoint__handle_insert_command_zero_value_size(void) {
  // Process Command
  uint8_t *resp_ptr =
      process_blob_db_command(s_insert_cmd_zero_value_size, sizeof(s_insert_cmd_zero_value_size));
...
void test_blob_db_endpoint__handle_insert_command_no_value_size(void) {
  ...
  // Process Command
  uint8_t *resp_ptr =
      process_blob_db_command(s_insert_cmd_no_value_size, sizeof(s_insert_cmd_no_value_size));
...
static const uint8_t s_insert_cmd_size_value_wrong[] = {
  ...
  0x21,
  0x00, // Size value is 1 more than it should be
...
void test_blob_db_endpoint__handle_insert_command_length_data_mismatch(void) {
  // Process Command
  uint8_t *resp_ptr =
      process_blob_db_command(s_insert_cmd_size_value_wrong, sizeof(s_insert_cmd_size_value_wrong));
...
void test_blob_db_endpoint__handle_insert_command_smallest_length(void) {
  // Process Command
  uint8_t *resp_ptr =
      process_blob_db_command(s_insert_cmd_smallest_length, sizeof(s_insert_cmd_smallest_length));
...
void test_blob_db_endpoint__handle_invalid_operation_command(void) {
  ...
  // Process Command
  uint8_t *resp_ptr =
      process_blob_db_command(s_invalid_operation_cmd, sizeof(s_invalid_operation_cmd));
