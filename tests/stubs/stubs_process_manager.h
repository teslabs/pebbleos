...
bool PBL_WEAK process_manager_compiled_with_legacy3_sdk(void) {
  return false;
}

PlatformType PBL_WEAK process_manager_current_platform(void) {
  return PBL_PLATFORM_TYPE_CURRENT;
}

void PBL_WEAK process_manager_put_kill_process_event(PebbleTask task, bool gracefully) {
  return;
}
...
void PBL_WEAK process_manager_send_callback_event_to_process(PebbleTask task,
