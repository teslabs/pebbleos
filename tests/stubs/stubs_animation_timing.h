...
AnimationProgress PBL_WEAK animation_timing_curve(AnimationProgress time_normalized,
                                                  AnimationCurve curve) {
  return time_normalized;
}

AnimationProgress PBL_WEAK animation_timing_scaled(AnimationProgress time_normalized,
