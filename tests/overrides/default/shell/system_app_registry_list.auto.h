...
static const AppRegistryEntry APP_RECORDS[] = {
  ...
  // System Apps
  {.id = APP_ID_SIMPLICITY, .type = AppInstallStorageFw, .md_fn = &simplicity_get_app_info},
  {.id = APP_ID_LOW_POWER_FACE, .type = AppInstallStorageFw, .md_fn = &low_power_face_get_app_info},
  ...
  {.id = APP_ID_SET_TIME, .type = AppInstallStorageFw, .md_fn = &set_time_get_app_info},
  {.id = APP_ID_QUICK_LAUNCH_SETUP,
   .type = AppInstallStorageFw,
   .md_fn = &quick_launch_setup_get_app_info},
  {.id = APP_ID_TIMELINE, .type = AppInstallStorageFw, .md_fn = &timeline_get_app_info},
  {.id = APP_ID_VOICE_UI, .type = AppInstallStorageFw, .md_fn = &voice_ui_app_get_info},
  {.id = APP_ID_LAUNCHER_MENU,
   .type = AppInstallStorageFw,
   .md_fn = &launcher_menu_app_get_app_info},
  {.id = APP_ID_LIGHT_CONFIG, .type = AppInstallStorageFw, .md_fn = &light_config_get_info},
  {.id = APP_ID_AMB_LIGHT_READ,
   .type = AppInstallStorageFw,
   .md_fn = &ambient_light_reading_get_info},
  {.id = APP_ID_WEATHER, .type = AppInstallStorageFw, .md_fn = &weather_app_get_info},
  {.id = APP_ID_BATTERY_CRITICAL,
   .type = AppInstallStorageFw,
   .md_fn = &battery_critical_get_app_info},
  {.id = APP_ID_HEALTH_APP, .type = AppInstallStorageFw, .md_fn = &health_app_get_info},
