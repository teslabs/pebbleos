  ...
  do {                                                                                         \
    ...
    if (!success) {                                                                            \
      ...
      sprintf(error_msg,                                                                       \
              ...
              "    rect_a: {%d,%d,%d,%d}\n"                                                    \
              "    rect_b: {%d,%d,%d,%d}\n",                                                   \
              rect_a.origin.x, rect_a.origin.y, rect_a.size.w, rect_a.size.h, rect_b.origin.x, \
              rect_b.origin.y, rect_b.size.w, rect_b.size.h);                                  \
  ...
  do {                                                                               \
    ...
    if (!success) {                                                                  \
      ...
      sprintf(error_msg,                                                             \
              ...
              "    size_a: {%d,%d}\n"                                                \
              "    size_b: {%d,%d}\n",                                               \
              size_a.w, size_a.h, size_b.w, size_b.h);                               \
      clar__assert(0, __FILE__, __LINE__, "Expression is not true: ", error_msg, 1); \
    }                                                                                \
  } while (0)
